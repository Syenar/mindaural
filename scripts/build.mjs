...
await mkdir('dist/vendor',{recursive:true}); await mkdir('dist/public',{recursive:true}); await mkdir('dist/legal',{recursive:true}); await mkdir('dist/assets/logos',{recursive:true});
