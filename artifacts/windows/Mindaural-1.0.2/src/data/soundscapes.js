const mk = (id, title, description, layers) => ({ id, title, description, layers, license: 'project-owned', provenance: 'Procedurally synthesized by Mindaural; no third-party recording.' });
