...
export function createDefaultProject(title='Untitled session'):Project{
 ...
 return {schemaVersion:'1.0.0',id:uid('project'),title,description:'A custom binaural session.',duration:1200,sampleRate:48000,masterGain:.8,voices:[v],noiseTracks:[],audioTracks:[],assets:[],segments:[{id:uid('segment'),name:'Main',start:0,duration:1200,repeat:1,crossfade:.05}],markers:[],evidence:{state:'Experimental',claim:'Custom stimulus; no outcome is guaranteed.'},provenance:{author:'Local user',createdAt:now,updatedAt:now,appVersion:APP_VERSION,engineVersion:ENGINE_VERSION},tags:[],revision:1};
}
